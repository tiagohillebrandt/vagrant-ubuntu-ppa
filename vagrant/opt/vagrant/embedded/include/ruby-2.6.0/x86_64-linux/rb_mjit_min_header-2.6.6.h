...
struct rb_method_definition_struct { unsigned int type : 4; int alias_count : 28; int complemented_count : 28; union { rb_method_iseq_t iseq; rb_method_cfunc_t cfunc; rb_method_attr_t attr; rb_method_alias_t alias; rb_method_refined_t refined; rb_method_bmethod_t bmethod; enum method_optimized_type optimize_type; } body; ID original_id; } __attribute__((packed));
...
typedef struct rb_execution_context_struct {
    ...
    uint8_t raised_flag;
    unsigned int method_missing_reason : 8;
...
struct iseq_catch_table { unsigned int size; struct iseq_catch_table_entry entries[0]; } __attribute__((packed));
static inline int
