...
void *rb_aligned_malloc(size_t, size_t) __attribute__ ((alloc_size (2)));
                                ...
                                struct rb_call_data *cd)
{
    ...
    const int lead_num = iseq->body->param.lead_num;
    VALUE * const ci_kws = ((VALUE*)__builtin_alloca (sizeof(VALUE)*(ci_kw_len)));
...
vm_opt_newarray_max(rb_num_t num, const VALUE *ptr)
{
 ...
 return __extension__({ const int rb_funcall_argc = (0); const VALUE rb_funcall_args[] = {}; const int rb_funcall_nargs = (int)(sizeof(rb_funcall_args) / sizeof(VALUE)); __extension__({ static struct rb_call_data rb_funcallv_data; rb_funcallv_with_cc(&rb_funcallv_data, ary, idMax, (((rb_funcall_argc) <= (rb_funcall_nargs)) ? (rb_funcall_argc) : (rb_fatal("argc(%d) exceeds actual arguments(%d)", rb_funcall_argc, rb_funcall_nargs), 0)), rb_funcall_nargs ? rb_funcall_args : ((void *)0)); }); });
    }
}
static VALUE
vm_opt_newarray_min(rb_num_t num, const VALUE *ptr)
{
 ...
 VALUE ary = rb_ary_new_from_values(num, ptr);
 return __extension__({ const int rb_funcall_argc = (0); const VALUE rb_funcall_args[] = {}; const int rb_funcall_nargs = (int)(sizeof(rb_funcall_args) / sizeof(VALUE)); __extension__({ static struct rb_call_data rb_funcallv_data; rb_funcallv_with_cc(&rb_funcallv_data, ary, idMin, (((rb_funcall_argc) <= (rb_funcall_nargs)) ? (rb_funcall_argc) : (rb_fatal("argc(%d) exceeds actual arguments(%d)", rb_funcall_argc, rb_funcall_nargs), 0)), rb_funcall_nargs ? rb_funcall_args : ((void *)0)); }); });
    }
}
static int
