...
Gem::Specification.new do |s|
  ...
  s.required_ruby_version = Gem::Requirement.new(["~> 2.4".freeze, "< 2.7".freeze])
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<childprocess>.freeze, ["~> 3.0.0"])
      ...
      s.add_runtime_dependency(%q<net-ssh>.freeze, ["~> 5.2.0"])
      ...
      s.add_runtime_dependency(%q<rest-client>.freeze, [">= 1.6.0", "< 3.0"])
      ...
      s.add_runtime_dependency(%q<vagrant_cloud>.freeze, ["~> 2.0.3"])
      ...
      s.add_dependency(%q<childprocess>.freeze, ["~> 3.0.0"])
      ...
      s.add_dependency(%q<vagrant_cloud>.freeze, ["~> 2.0.3"])
