...
Gem::Specification.new do |s|
  ...
  s.required_ruby_version = Gem::Requirement.new(["< 2.7".freeze, "~> 2.2".freeze])
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<i18n>.freeze, ["~> 1.1.1"])
      ...
      s.add_runtime_dependency(%q<net-ssh>.freeze, ["~> 5.1.0"])
      ...
      s.add_runtime_dependency(%q<vagrant_cloud>.freeze, ["~> 2.0.2"])
      ...
      s.add_dependency(%q<i18n>.freeze, ["~> 1.1.1"])
      ...
      s.add_dependency(%q<net-ssh>.freeze, ["~> 5.1.0"])
      ...
      s.add_dependency(%q<vagrant_cloud>.freeze, ["~> 2.0.2"])
