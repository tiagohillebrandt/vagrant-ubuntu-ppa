...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<mime>.freeze, ["~> 0.4.4"])
      s.add_runtime_dependency(%q<net-ssh>.freeze, ["~> 6.0"])
      ...
      s.add_dependency(%q<mime>.freeze, ["~> 0.4.4"])
      s.add_dependency(%q<net-ssh>.freeze, ["~> 6.0"])
